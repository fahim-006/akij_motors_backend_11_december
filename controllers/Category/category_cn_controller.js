...
const  Category_cn = models.Category_cn;

//create create_Category_en
exports.create_Category_cn = async function (req, res) {
  let body = req.body;
  try {
      await Category_cn.create({
        Category_cn: body.Category_cn,
      })      
      .then((category_cn) => {
        //console.log("user created");
        res.status(200).json("created successfully");
        res.json(category_cn)
      })
      .catch((err) => {
