...
//  Description: Conversion details model english file for rest api project
    ...
    return sequelize.define( //To define mappings between
      ...
      'Conversion_details_en',
      {
        ...
        conversion_Name_id: {
          ...
          field: 'conversion_Name_id',
        },

        conversion_name_details: {
            type: DataTypes.STRING,
            allowNull: false,
            required: true,
            field: 'conversion_name_details',
          },
      },
      {
        tableName: 'conversion_details_en',
      }
    )
  }
